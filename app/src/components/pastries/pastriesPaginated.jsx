...
import { useGetPastriesWithPaginationQuery } from '../../store/services/pastries';

const PastriesPaginated = ({ pastries }) => {
  const [offset, setOffset] = useState(0);
  const [limit, setLimit] = useState(4);
  const { data, error, isLoading } = useGetPastriesWithPaginationQuery({ offset, limit });
...
export default PastriesPaginated;
